...
namespace Store.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            ViewData["CategoryId"] = new SelectList(_context.Set<ProductCategory>(), "Id", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Brand,Sku,Description,CategoryId,Model")] Product product, IFormFile? frontPhoto, IFormFile? rearPhoto)
        {
            ...
            ViewData["CategoryId"] = new SelectList(_context.Set<ProductCategory>(), "Id", "Name", product.CategoryId);
            return View(product);
        }
